                                    ...
                                    <form action="" @submit.prevent="submit" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="8" v-model="form.short_description"
                                                name="short_description" placeholder="Enter Short Description"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="8" v-model="form.long_description"
                                                name="long_description" placeholder="Enter Long Description"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="discount_price" v-model="form.discount_price"
                                                class="form-control" placeholder="Enter course discount_price" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img :src="'/course/' + form.image" style="height: 80px; width: 80px;"
                                                alt="course image" />
...
const submit = () => {
    form.post(route("update.course", props.course.id), {
        forceFormData: true,
    });
};
</script>
